...
function KickIcon(props: IconProps) {
  // Exact path from simple-icons/icons/kick.svg (official Kick brand mark)
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
function InstagramIcon(props: IconProps) {
  // Official Instagram glyph (Simple Icons / Meta brand path, viewBox 0 0 24 24)
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
function TikTokIcon(props: IconProps) {
  // Official TikTok glyph (Simple Icons brand path, viewBox 0 0 24 24)
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function SocialIcon({ id, className, ...props }: SocialIconProps) {
  const Icon = ICONS[id];
  return <Icon className={cn("icon-crisp", className)} {...props} />;
}
