...
function VideosIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden {...props}>
      ...
      <path d="M17 10.5 21 8v8l-4-2.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function LiveIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
      ...
      <circle cx="12" cy="12" r="8" fill="none" stroke="currentColor" strokeWidth="1.6" opacity="0.45" />
    </svg>
  );
}
